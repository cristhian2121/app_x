...
const Prueba = () => {
  ...
  return (
    <Container sx={{ width: "80%", minWidth: '390px', height: "100vh", backgroundColor: "white", p:0 }} disableGutters>
        <Typography>Hola</Typography>
        <Typography>Hola</Typography>
        <Typography>Hola</Typography>
        
        <MessagesUI mensajes={mens} user={info} role='estudiante' enviarMensajes={enviarMensajes}/>
    </Container>
